...
//               Around The Us was my very first project, built entirely with
//               JavaScript. It's a social media profile page where users can
//               customize their profile picture, name, bio, and add or remove
//               photos. I focused on learning Object-Oriented Programming (OOP)
//               while building it. The website connects to an API to store user
//               data. Take a look!
//             </p>
//           </div>
//         </div>
